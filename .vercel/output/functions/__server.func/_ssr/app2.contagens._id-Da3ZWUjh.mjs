...
import { t as Route } from "./app.contagens._id-CzQTS_wz.mjs";
import { n as stringType, t as objectType } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app2.contagens._id-Da3ZWUjh.js
...
function RoundPanel({ roundId, countId, products, blind, disabled }) {
	...
	const [locFilter, setLocFilter] = (0, import_react.useState)("TODAS");
	...
	const locations = (0, import_react.useMemo)(() => {
		const locs = new Set((products ?? []).map((p) => p.localizacao).filter(Boolean));
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
					...
					variant: "outline",
					size: "sm",
					onClick: () => exportToPDF(`Lista de contagem ${locFilter !== "TODAS" ? `- ${locFilter}` : ""}`, [
						"COD. REFERENCIA",
						"COD. AUXILIAR",
						"FABRICANTE",
						"LOCALIZAÇÃO",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input$1, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "Filtrar por localização" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
							value: "TODAS",
							children: "Todas as localizações"
						}), locations.map((loc) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
							value: loc,
							children: loc
						}, loc))] })]
					})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableBody, { children: displayFiltered.map((p) => {
			...
			filtered.length > 200 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
