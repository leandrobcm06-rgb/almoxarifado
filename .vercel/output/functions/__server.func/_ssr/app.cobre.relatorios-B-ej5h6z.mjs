...
//#region node_modules/.nitro/vite/services/ssr/assets/app.cobre.relatorios-B-ej5h6z.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function ReportsView() {
	const [reportType, setReportType] = (0, import_react.useState)("cobre_estoque");
	...
	const handleGenerate = async (formatType) => {
		...
		try {
			if (reportType === "cobre_estoque") {
				...
				let query = supabase.from("copper_movements").select("*, bar:copper_bars(name)").in("type", [
					"corte",
					"devolucao",
					"ajuste_entrada"
				]);
				...
				const flatData = data.map((d) => ({
					...
					tipo: d.type,
					barra: d.bar?.name,
					comprimento_m: (d.length_mm / 1e3).toFixed(2),
					responsavel: d.responsible
				}));
				if (formatType === "csv") exportCSV("Entradas_Cobre", [
					"data",
					"tipo",
					"barra",
					"comprimento_m",
				...
				else printView("Histórico de Entradas de Cobre", flatData, [
					"Data/Hora",
					"Tipo",
					"Barra",
					"Tamanho (m)",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
			...
			children: "Relatórios de Cobre"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-muted-foreground",
			children: "Exporte dados do estoque e movimentações de cobre para análise."
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Selecione o Relatório" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "Selecione..." }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
								value: "cobre_estoque",
								children: "Posição Atual de Estoque (Pedaços Disponíveis)"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
								value: "cobre_consumo",
								children: "Histórico de Consumo (Saídas p/ Clientes e Obras)"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
								value: "cobre_entradas",
								children: "Histórico de Entradas (Devoluções e Novos Cortes)"
							})
						] })]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Data Inicial (Filtro para históricos)" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
							...
							disabled: reportType === "cobre_estoque"
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "space-y-2",
