...
import { d as getRequest } from "./esm-B5zcwdrx.mjs";
import { t as createMiddleware } from "./createStart-BWB9HM9w.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-middleware-DKUiPm7z.js
...
var requireSupabaseAuth = createMiddleware({ type: "function" }).server(async ({ next }) => {
	...
	if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
		const message = `Missing Supabase environment variable(s): ${[...!SUPABASE_URL ? ["SUPABASE_URL"] : [], ...!SUPABASE_PUBLISHABLE_KEY ? ["SUPABASE_PUBLISHABLE_KEY"] : []].join(", ")}. Please configure them in your .env file.`;
